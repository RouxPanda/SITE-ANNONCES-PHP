<div class="col-lg-2" style="height: 700px;width: 366px;">
    <div class="vertical-nav" style="background: rgb(255,255,255);width: 171px;">
        ...
        <ul class="vertical-nav-list">
            <li class="vnav-li"><a class="active-link vnav-link" href="/Account/manage/">Son compte</a></li>
            <li class="vnav-li"><a class="vnav-link" href="/Account/manage/ses_annonces">Ses annonces</a></li>
