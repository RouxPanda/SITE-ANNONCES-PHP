...
class Home extends BaseController
{
	...
	public function view($page = 'home') {
		...
		if($page = 'home') {
			$datas = $annonceModel->orderBy('A_idannonce', 'desc')->where('A_etat',2)->where('A_blocked', false)->findAll(6, 0);
	...
	public function search() {
		...
		if ($this->request->getMethod() == 'get') {
			...
			$datas = $annonceModel->where('A_etat',2)->where('A_blocked', false)->orderBy('A_idannonce', 'desc')->findAll();
		}
